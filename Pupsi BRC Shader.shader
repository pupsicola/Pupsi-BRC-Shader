	...
	LOD 0
		...
		Pass
		{
			...
			float4 frag (v2f i ) : SV_Target
			{
				...
				outOutlineAlpha = (( _VertexColorsDefineOutlineCoverage )?( ( i.ase_color * 1.0 ) ):( temp_cast_30 )).r;
...
ASEEND*/
//CHKSM=494CDCBB1E895C13AE34404C42CDBD48F5087142